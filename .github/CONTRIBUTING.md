# Contributing Guidelines for P-Play
...
To make a GitHub issue for P-Play, please visit the [new issue page](https://github.com/p-stream/p-stream/issues/new/choose) where you can pick either the "Bug Report" or "Feature Request" template.
...
GitHub issues are how we track our bugs and feature requests that will be implemented into P-Play - all contributions **must** have an issue and be approved by a maintainer before a pull request can be worked on.
...
If you're here because you'd like to work on an issue, amazing! Thank you for even considering contributing to P-Play; it means a lot :heart:
...
Our recommended development environment to work on P-Play is:
...
- Keep as much as possible to the style of P-Play. Look around our codebase to familiarise yourself with how we do things!
...
Language contributions help P-Play massively, allowing people worldwide to use our app!
